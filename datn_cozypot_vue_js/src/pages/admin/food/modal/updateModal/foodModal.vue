              ...
              <div class="form-row-2">
                ...
                <div class="form-group">
                  ...
                  <div class="image-action-bar">
                    ...
                    <button type="button" class="btn-action btn-upload" @click="triggerFileInput">
                      <i class="fas fa-cloud-upload-alt"></i> Thay đổi ảnh
                    </button>

                    <button type="button" class="btn-action btn-remove" v-if="formData.hinhAnh" @click="removeImage">
                      <i class="fas fa-trash"></i> Xóa
                    </button>
                  </div>

                  <div class="image-preview-container" :class="{ 'has-image': formData.hinhAnh }">
                    <img v-if="formData.hinhAnh" :src="getImg(formData.hinhAnh)" alt="Preview Món Ăn">
