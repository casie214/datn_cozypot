...
const { 
  ...
  handleFileUpload // Import upload function
} = useFoodAddScreen();
      ...
      <div class="card general-info">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input v-model="formData.tenMonAn" type="text" class="form-control" placeholder="Ví dụ: Trà sữa Trân châu">
            </div>
            <div class="form-group">
                <label>Giá hiển thị (VNĐ)</label>
                <input v-model="formData.giaBan" type="number" class="form-control" placeholder="0">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="image-upload-box">
                ...
                <input v-model="formData.hinhAnh" type="text" class="form-control mt-2" placeholder="Hoặc dán link ảnh tại đây...">
        ...
        <div class="add-detail-box">
            <div class="detail-inputs">
                <div class="input-wrap">
                    ...
                    <input v-model="newDetail.tenChiTiet" type="text" placeholder="Size L...">
                </div>
                <div class="input-wrap">
                    <label>Kích cỡ</label>
            ...
            <table class="detail-table">
                ...
                <tbody>
                    <tr v-for="(detail, index) in listChiTiet" :key="index">
                        <td>{{ detail.tenChiTiet }}</td>
                        <td>{{ detail.kichCo }}</td>
                        <td style="color: #d32f2f; font-weight: bold;">{{ detail.giaBan.toLocaleString() }} đ</td>
                        <td>{{ detail.donVi }}</td>
                        <td>
                    ...
                    <tr v-if="listChiTiet.length === 0">
                        <td colspan="5" class="empty-text">Chưa có biến thể nào được thêm.</td>
                    </tr>
                </tbody>
            </table>
        </div>
