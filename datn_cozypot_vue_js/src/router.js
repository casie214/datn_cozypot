    ...
    children: [
      {
        ...
        name: "clientList",
        component: () =>
          import("@/pages/admin/client/modal/clientListContent.vue"),
      ...
      },
      {
        ...
        name: "clientView",
        component: () =>
          import("@/pages/admin/client/modal/clientDetailPage.vue"),
    ...
    children: [
      {
        ...
        name: "staffManager",
        component: () =>
          import("@/pages/admin/staff/modal/staffListContent.vue"),
      },
      {
        path: "form/:id?",
        name: "staffForm",
      ...
      },
      {
        ...
        name: "staffView",
        component: () =>
          import("@/pages/admin/staff/modal/staffDetailPage.vue"),
      },
    ],
  },
