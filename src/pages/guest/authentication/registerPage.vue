            ...
            <section class="py-3 py-md-5 py-xl-8 etched-container-2">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-5">
                                <h2 class="display-5 fw-bold text-center">Create Account</h2>
                                <p class="text-center m-0">Already have an account? <a @click="navigateLogin" style="text-decoration: underline; color: red; cursor: pointer;">Log in</a></p>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-floating mb-3">
                                                    <input type="text"
                                                        ...
                                                        name="fullname" id="fullname" placeholder="John Doe" required>
...
name="password" id="password" value="" placeholder="Password"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label text-secondary" for="iAgree">
                                                        I agree to the <a href="#!"
                                                            class="link-secondary text-decoration-none">Terms and
                                                            Conditions</a>
                                                    </label>
                                                </div>
                                            </div>
                                ...
                                <div
                                    ...
                                    <div class="bg-dark w-100 d-lg-none" style="height: 1px; --bs-bg-opacity: .1;">
                                    </div>
                                    <div>or</div>
                                    <div class="bg-dark h-100 d-none d-lg-block"
                                        style="width: 1px; --bs-bg-opacity: .1;"></div>
...
class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
                                            ...
                                            <span class="ms-2 fs-6 flex-grow-1">Join with Google</span>
                                        </a>
                                        <a href="#!"
                                            class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            <span class="ms-2 fs-6 flex-grow-1">Join with Facebook</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
