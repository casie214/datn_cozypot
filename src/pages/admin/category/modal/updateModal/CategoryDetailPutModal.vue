<script setup>
import { useCategoryDetailPutModal } from '../../../../../services/foodFunction'; // Adjust path as needed
...
<template>
  <div v-if="isOpen" class="modal-overlay" @click.self="closeModal">
    ...
    <div class="modal-content" @click="closeDropdown">
          ...
          <div class="form-group full-width relative-container">
            ...
            <div v-if="isDropdownOpen" class="dropdown-list-container" @click.stop>
              <div class="search-box-wrapper">
                <input v-model="searchQuery" type="text" class="dropdown-search-input" placeholder="🔍 Tìm kiếm..."
                  autofocus>
              </div>
